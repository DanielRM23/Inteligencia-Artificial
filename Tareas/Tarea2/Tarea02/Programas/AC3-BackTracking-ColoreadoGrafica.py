...
# Problema de coloreado de Grafo usando BackTracking y Ac3
...
def grafica(archivo, numero_colores):
    ...
    # Cada color es representado por un número
...
# Se recomiendo variar el número de colores 
